...
|                     |                                 |                                                        | registerCustomer(String phoneNumber)                         | Return UUID of customer with phone number                    |                            |
...
|                     |                                 |                                                        | sendStatement(String message, UUID customerId)               | If customer exsists and provided phone number                | Return sent message status |
|                     |                                 |                                                        |                                                              | If customer doesn't exist / doesn't have phone number        | Message not sent notice    |
...
| Customer            | String phoneNumber              | phone number to receive bank statement messages        |                                                              |                                                              |                            |
| MessageService      | String ACCOUNT_SID              | Twilio service id                                      | send(String messageText, Customer customer)                  | Send message to customer                                     | Message status             |
|                     | String AUTH_TOKEN               | Twilio service auth token                              |                                                              |                                                              |                            |
|                     | String FROM_PHONE_NUMBER        | Sender phone number                                    |                                                              |                                                              |                            |