...
public class CurrentAccountTest {
    ...
    public void testDeposit_ShouldReturnTrueAndBalanceShouldBeCorrect(){
        ...
        boolean depositResult = currentAccount.deposit(depositAmount2);
    ...
    public void testDeposit_WhenAmountNotValid_ShouldReturnFalseAndBalanceShouldNotChange(){
        ...
        boolean depositResult = currentAccount.deposit(invalidDepositAmount);
        float checkBalanceResult = currentAccount.checkBalance();
    ...
    public void testGenerateBankStatement_ShouldReturnGeneratedStatement(){
        ...
        String generateBankStatementResult = currentAccount.generateBankStatement();
