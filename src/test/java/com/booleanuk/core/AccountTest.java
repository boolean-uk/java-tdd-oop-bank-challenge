...
public class AccountTest {
    ...
    public void testCreatingStatement() {
        ...
        transactions.add(new Transaction(LocalDateTime.of(2012, 1, 14, 0, 0, 0), BigDecimal.valueOf(1_000), null, BigDecimal.valueOf(1_000)));
        transactions.add(new Transaction(LocalDateTime.of(2012, 1, 13, 0, 0, 0), BigDecimal.valueOf(2_000), null, BigDecimal.valueOf(3_000)));
        transactions.add(new Transaction(LocalDateTime.of(2012, 1, 10, 0, 0, 0), null, BigDecimal.valueOf(500), BigDecimal.valueOf(2_500)));
