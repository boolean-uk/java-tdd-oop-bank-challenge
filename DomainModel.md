...
| requestOverdraft(Customer customer, int accountId, double sizeOfOverdraft) |                                                | Customer wants to request an overdraft for an account where they already have overdraft of the size                                   | "You already have an approved overdraft for this account and amount." |
...
| approveAndRejectOverdrafts()                                               |                                                | Bank manager wants to approve or reject requests                                                                                      | void                                                                  |
